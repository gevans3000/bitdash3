...
this.adx = this.adx ? ((this.adx * (this.adxPeriod - 1)) + Math.abs(this.plusDI - this.minusDI) / Math.max(this.plusDI, this.minusDI) * 100) / this.adxPeriod : Math.abs(this.plusDI - this.minusDI) / Math.max(this.plusDI, this.minusDI) * 100;
}
